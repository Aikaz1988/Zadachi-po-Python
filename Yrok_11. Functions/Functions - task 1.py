...
for i in range(factorial(n), 0, -1): # функция range начинается с факториала введенного числа factorial(n) и уменьшается до 1 с шагом -1
    list_fac.append(i) # добавляем факториал числа i в список list
